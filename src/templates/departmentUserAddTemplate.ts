const departmentUserAdd = function (
                ...
                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0"
                  ...
                  align="left">
                      ...
                      <p style="margin: 0 0 4px;">
                        You have been added to the Arkar POS dashboard for ${departmentName} Role.
                      </p>
                      ...
                      <p style="margin: 20px 0 2px;">Welcome to the Arkar POS Dashboard. We are excited to have you onboard.</p>
                      <p style="margin: 0 0 0px;">Arkar POS Support</p>
                      ...
                      Have additional questions or need direct assistance? <br /> Contact our team at 
                        <a href="mailto:arkarphyo@mwc.com.mm" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">arkarphyo@mwc.com.mm</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
